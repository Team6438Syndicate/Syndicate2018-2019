...
public class SingleControllerTeleOP extends OpMode
{
    ...
    public void loop()
    {
         ...
         * Intake Slide logic
         */
        if(gamepad1.dpad_left && (robot.intakeSlide.getCurrentPosition() < robot.slideExtend) )
        {
        ...
        else if(gamepad1.x && robot.intakeSpinner.getCurrentPosition() == 0)
        {
    ...
    //Method to spin the intake (Could have each individual servo or one with a y splitter - unsure at the current point
